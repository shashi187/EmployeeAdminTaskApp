...
const AcceptTask = ({data}) => {
  return (
      <div className='bg-red-400 h-full flex-shrink-0 rounded-2xl p-5 w-[320px]'>
        ...
        <div>
            <button className='bg-green-500 text-white px-4 py-2 mt-5 rounded-md hover:bg-blue-600'>Mark as Completed</button>
            <button className='bg-red-500 text-white px-4 py-2 mt-5 ml-2 rounded-md hover:bg-gray-600'>Failed</button>
        </div>
      </div>
    )
}
